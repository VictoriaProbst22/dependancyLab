...
public class StreamLabService {
    ...
    public List<User> ProblemSix()
    {
        ...
        //return users.findAll().stream().filter(u-> u.getRegistrationDate().compareTo(2016 2018)).toList();
        return null;
    }
    ...
    public Product ProblemTwelve()
    {
        ...
        newProduct.setName("Lightsaber");
        newProduct.setPrice(100);
        newProduct.setDescription("Glowing Weapon of Awesomeness");
        newProduct.setId(8);
